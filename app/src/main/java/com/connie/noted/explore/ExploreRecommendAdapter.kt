...
import com.connie.noted.databinding.ItemBoardRecommendBinding
 ...
 */
class ExploreRecommendAdapter(
    private val onClickListener: OnClickListener,
    val viewModel: ExploreViewModel
) :
    ListAdapter<Board, ExploreRecommendAdapter.BoardViewHolder>(DiffCallback) {

    class BoardViewHolder(private var binding: ItemBoardRecommendBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        return BoardViewHolder(
            ItemBoardRecommendBinding.inflate(
